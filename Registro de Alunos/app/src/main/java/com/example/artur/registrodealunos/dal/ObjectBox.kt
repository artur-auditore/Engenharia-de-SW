package com.example.artur.registrodealunos.dal

import android.content.Context
import android.os.Environment
import com.example.artur.registrodealunos.Modelo.MyObjectBox
...
//        boxStore = MyObjectBox.builder().androidContext(context.applicationContext).directory(directory)
//                .build()
    }
}
